                        ...
                        <div class="col-md-4">
                            <div class="profile__left">
                                <div class="profile-name">
                                    ...
                                    @else
                                    {{$_ENV['BASE_URL'].'/backend/assets/images/userImages/defaultImage.png'}}
                                    @endif
                                    ...
                                    <form action="/superFood/admin/userProfile/update/{{$user->id}}" method="POST" enctype="multipart/form-data">
                                        <div class="avatar form-group">
                                            ...
                                            <div class="avatar_img" style="width: 60%">
                                                ...
                                                <a href="/admin/userProfile/delete/{{$user->id}}" style="border: none; background: transparent" class="avatarDelete"><i class="fas fa-times"></i></a>
                                            </div>
                                        </div>
