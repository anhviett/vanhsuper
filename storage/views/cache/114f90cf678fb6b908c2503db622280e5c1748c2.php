                ...
                <div style="width: 40%; margin: auto">
                    <form action="/superFood/admin/users/update/<?php echo e($user->id); ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group position-relative text-center">
                            <img class="imagesForm" width="100" src="<?php if($_SESSION['user']['images']): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XamPP\xam\htdocs\SuperFood\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>