                        ...
                        <div class="col-md-4">
                            <div class="profile__left">
                                <div class="profile-name">
                                    <img id="profileInfo_avatar" style="border-radius: 50%" src="
                                    <?php if($_SESSION['user']['images']): ?>
                                    <?php echo e($_SESSION['user']['images']); ?>

                                    <?php else: ?>
                                    <?php echo e($_ENV['BASE_URL'].'/backend/assets/images/userImages/defaultImage.png'); ?>
                                    ...
                                    <form action="/superFood/admin/userProfile/update/<?php echo e($user->id); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="avatar form-group">
                                            ...
                                            <div class="avatar_img" style="width: 60%">
                                                ...
                                                <a href="/admin/userProfile/delete/<?php echo e($user->id); ?>" style="border: none; background: transparent" class="avatarDelete"><i class="fas fa-times"></i></a>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XamPP\xam\htdocs\SuperFood\resources\views/admin/userProfile/edit.blade.php ENDPATH**/ ?>